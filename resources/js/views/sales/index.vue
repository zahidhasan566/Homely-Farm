    ...
    <div class="container-fluid">
        ...
        <advanced-datatable :options="tableOptions">
            ...
            <template slot="print" slot-scope="row" >
                <router-link class="btn btn-primary" style="font-size: 12px;width:65px;padding: 2px 0px" target='_blank' :to="{path: `${baseurl()}`+'sales-print?action_type=challan&SalesCode='+row.item.SalesCode}"><i class="fa fa-print">Invoice</i></router-link>
                <router-link class="btn btn-primary" style="font-size: 12px;width:65px;padding: 2px 0px" target='_blank' :to="{path: `${baseurl()}`+'sales-print?action_type=print&SalesCode='+row.item.SalesCode}"><i class="fa fa-print">Challan</i></router-link>
